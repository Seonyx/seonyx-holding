...
try {
    ...
    Write-Host "Search 'Show List' button in book editor" -ForegroundColor Cyan
    ...
    Write-Host "2. Do a search in the editor - 'Show List' button appears when there are matches." -ForegroundColor White
    Write-Host "3. Click Show List - a new tab opens with all matching paragraphs as plain text." -ForegroundColor White
    Write-Host ""
